...
- `efd` / `empty-framework-dir` → `cf` / `clean-frameworks`
...
> This was the first v3 release with major breaking changes. See the breaking changes section above for migration guidance.
